function init() {
        ...
        myDiagram.nodeTemplateMap.add("", // the default category
            $(go.Node, "Spot", nodeStyle(),
                ...
                $(go.Panel, "Auto",
                    $(go.Shape, "Rectangle", { fill: "#257a9f", stroke: null },
    ...
    function load() {
        myDiagram.model = go.Model.fromJson({
            ...
            "nodeDataArray": [
                { "key": 1, "loc": "100 170", "text": "begin" },
                { "key": 2, "loc": "200 170", "text": "demo01" },
                { "key": 3, "loc": "300 100", "text": "set01" },
                { "key": 4, "loc": "300 170", "text": "set02" },
                { "key": 5, "loc": "300 230", "text": "set03" },
                { "key": 6, "loc": "500 170", "text": "end" }
            ],
            "linkDataArray": [
                { "from": 1, "to": 2, "fromPort": "R", "toPort": "L" },
                { "from": 2, "to": 3, "fromPort": "R", "toPort": "L" },
                { "from": 2, "to": 4, "fromPort": "R", "toPort": "L" },
                { "from": 2, "to": 5, "fromPort": "R", "toPort": "L" },
                { "from": 3, "to": 6, "fromPort": "R", "toPort": "L" },
                { "from": 4, "to": 6, "fromPort": "R", "toPort": "L" },
